...
def chk(): 
  ...
  print("\n\n\x1b[37;1mYour ID : "+id) 
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/shwansorany80/Shwanaid.txt/main/shwan.txt").text 
    if id in httpCaht: 
      ...
      print("\x1b[91mId Active nya Bo Active Krdn nama bom bo bnera@sH1Xe\033[97m") 
      os.system("xdg-open https://t.me/sH1Xe")
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
...
\033[1;91m---------------------------------------------
\033[36;1mAUTHOR  : \033[31;1mSHERA
\033[36;1mTELEGRAM: \033[31;1@u69xi
\033[36;1mChannal : \033[31;1mSHERA_CRACK
\033[36;1mChannal : \033[31;1mSHERA_CRACK
\033[1;91m---------------------------------------------
"""
#---------------------
